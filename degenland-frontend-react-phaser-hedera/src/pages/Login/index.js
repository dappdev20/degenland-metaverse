        ...
        <>
            <div className="login-container">
                <div className="login-wrapper box-shadow">
                    <div className="decorating-wrapper">
                        <img alt="" src={"/imgs/front/border-decoration.png"} />
                        <img alt="" src={"/imgs/front/border-decoration.png"} />
                        <img alt="" src={"/imgs/front/border-decoration.png"} />
                        <img alt="" src={"/imgs/front/border-decoration.png"} />
                    </div>
                                ...
                                <div>
                                    <div className="width-100 display-flex flex-row item-center">
                                        <span style={{
                                            ...
                                            fontSize: "18px",
                                            fontWeight: "500"
                                        }}>This is an unregistered wallet!</span>
                                    </div>
                            ...
                            }
                            {
                                ...
                                <div>
                                    ...
                                    <div className="width-100 display-flex flex-row mt-3 customize-scroll-bar"
                                        style={{ height: "110px" }}>
                                        <NftCardSmall singleNftInfo={{ imgUrl: "imgs/front/nfts/degenland.png", name: "Degenland", nftCount: walletNftInfo.degenlandCount }} />
                                        <NftCardSmall singleNftInfo={{ imgUrl: "imgs/front/nfts/tycoon.png", name: "Tycon", nftCount: walletNftInfo.tycoonCount }} />
                                    </div>
                                    ...
                                    <div className="width-100 display-flex flex-row item-center mt-3">
                                        <Button className="button-style1" style={{ width: "160px" }} onClick={() => { history.push('/main') }} >Log In</Button>
                                    </div>
                                </div>
                            }
                        </div>
